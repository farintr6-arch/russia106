...
function ultimate.LoadConfig()
    ...
    if not file_Exists( "ultimate/"..str..".txt", "DATA" ) then return end
...
function ultimate.CreateConfig()
    ...
    local tojs = util.TableToJSON( ultimate.cfg, false )
    file_CreateDir("ultimate")
    file_Write( "ultimate/"..name..".txt", tojs )
    ultimate.fillConfigTable()
    ultimate.initTab("Settings")
end
...
function ultimate.tabs.Aimbot()
    ...
    ultimate.ui.CheckBox( p, "Knife bot", "Knifebot","Automatically hit target with knife(support SWB, HL2, CS:GO", false, false, false, ultimate.spfuncs[3] )
        ...
        if not isVisible then 
            if ultimate.cfg.vars["Lines"] then
                ...
                if distance <= maxDistance then
                    ...
                    local col = string_ToColor( ultimate.cfg.colors["Lines"] )
